<title>پنل <?=($user->isAdmin($_SESSION['userId']))?'مدیریت':'کاربری'?> | اضافه کردن خبر جدید</title><div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="field placeholder">
                                                        ...
                                                        <label for="code" class="active">عنوان خبر</label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="field">
                                                ...
                                                <div class="col-sm-6 offset-sm-3">
                                                    <div class="field placeholder">
                                                        <select class="form-control" name="frm[category]" id="category">
                                                            <option value="location">مکان های اقامتی</option>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field placeholder cke_rtl">
                                                        <textarea rows="10" class="form-control" id="body" name="frm[body]"></textarea>
